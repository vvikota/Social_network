...
# Generic React Components
  Используются когда нужно типизировать компонент и у него возврщаемое значение зависит от переданного.
  Такие компоненты могут работать с несколькими типами данных.
